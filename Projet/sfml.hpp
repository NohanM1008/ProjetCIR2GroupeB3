...
// Constantes
extern const unsigned int WINDOW_WIDTH; // Largeur de la fenêtre
extern const unsigned int WINDOW_HEIGHT; // Hauteur de la fenêtre
...
sf::Vector2f worldToScreen(Position pos); // Convertit une position 3D en 2D
...
void dessinerInfoBulle(sf::RenderWindow& window, Avion* avion, const sf::Font& police, float zoom); // Affiche les infos de l'avion sélectionné